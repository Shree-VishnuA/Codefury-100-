export const sampleResumeData = {
  ...
  skills: {
    ...
    tools: ["Git", "Docker", "AWS", "Tailwind CSS", "Jest", "Vercel"],
  },
  projects: [
    {
      id: "proj-1",
  ...
  achievements: [
    {
      id: "ach-1",
      title: "First Place Winner - SF Tech Hackathon 2024",
      description: "Recognized for best application of Generative AI in developer tooling.",
    },
  ],
};
